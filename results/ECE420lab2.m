...
Y2 = ['array - count:', num2str(count2), '  mean:', num2str(stats2.mean), '  median:', num2str(stats2.median), '  min:', num2str(stats2.min), '  max:', num2str(stats2.max)];
Y3 = ['rwl - count:', num2str(count3), '  mean:', num2str(stats3.mean), '  median:', num2str(stats3.median), '  min:', num2str(stats3.min), '  max:', num2str(stats3.max)];
disp(Y1);
disp(Y2);
disp(Y3);
fclose(file1);
